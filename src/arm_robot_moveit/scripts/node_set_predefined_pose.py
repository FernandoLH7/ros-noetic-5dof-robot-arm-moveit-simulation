...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        gripper.set_pose("opened_gripper")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        arm.set_pose("get_out_pick_b")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        arm.set_pose("pick_pose_b")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        gripper.set_pose("gripper_pick")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        ...
        arm.set_pose("get_out_place_b")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        arm.set_pose("place_pose_b")
        #Wait for 2 seconds
        rospy.sleep(0.1)
        ...
        arm.set_pose("get_out_pick_r")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        arm.set_pose("pick_pose_r")
        #Wait for 2 seconds
        rospy.sleep(0.3)   
        ...
        arm.set_pose("get_out_place_r")
        #Wait for 2 seconds
        rospy.sleep(0.3)
        
        arm.set_pose("place_pose_r")
        #Wait for 2 seconds
        rospy.sleep(0.3)
